...
//------------------------------------------------------------Geração da tabela-------------------------------------------------------------------------
    ...
    private function geraTabela($param = array()) {
        ...
        try {
            ...
            $comando = $pdo->query('SELECT * FROM cad_categoria WHERE ' . $expre . ' ORDER BY ' . $param[0] . ' LIMIT ' . $param[1] . ' OFFSET ' . $param[2]);
            ...
            echo "<table class=priTbl>
                        ...
                        <div class=divPriTitTr>
                            ...
                            <div class=divTitTr><a href=?tbl=2>Nome</a></div>
            ...
            foreach ($listar as $list):
                echo "<tr>
                        <div class=divPriTr>
                            ...
                            <div class=divtr>" . $list['Nome'] . "</div>
                            <div class=divtrOpr><a href=telaEditaCategoria.php?id=" . $list['id'] ."> <img src= ../imagensSistema/imgEditar.jpg width=40 height=40 alt=sort_both/></a></div>
...
//--------------------------------------------------------------Rodape Paginação------------------------------------------------------------------------
            ...
            $sql = $pdo->query('SELECT COUNT(id) AS contagem FROM cad_categoria WHERE ' . $expre . ' LIMIT 500');
